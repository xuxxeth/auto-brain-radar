var webExtCoreFakeBrowser=(function(e){Object.defineProperty(e,Symbol.toStringTag,{value:`Module`});var t=Object.create,n=Object.defineProperty,r=Object.getOwnPropertyDescriptor,i=Object.getOwnPropertyNames,a=Object.getPrototypeOf,o=Object.prototype.hasOwnProperty,s=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),c=(e,t,a,s)=>{if(t&&typeof t==`object`||typeof t==`function`)for(var c=i(t),l=0,u=c.length,d;l<u;l++)d=c[l],!o.call(e,d)&&d!==a&&n(e,d,{get:(e=>t[e]).bind(null,d),enumerable:!(s=r(t,d))||s.enumerable});return e},l=((e,r,i)=>(i=e==null?{}:t(a(e)),c(r||!e||!e.__esModule?n(i,`default`,{value:e,enumerable:!0}):i,e)))(s(((e,t)=>{var n=200,r=`__lodash_hash_undefined__`,i=800,a=16,o=9007199254740991,s=`[object Arguments]`,c=`[object Array]`,l=`[object AsyncFunction]`,u=`[object Boolean]`,d=`[object Date]`,f=`[object Error]`,p=`[object Function]`,m=`[object GeneratorFunction]`,h=`[object Map]`,g=`[object Number]`,_=`[object Null]`,v=`[object Object]`,y=`[object Proxy]`,ee=`[object RegExp]`,b=`[object Set]`,te=`[object String]`,ne=`[object Undefined]`,x=`[object WeakMap]`,re=`[object ArrayBuffer]`,ie=`[object DataView]`,ae=`[object Float32Array]`,oe=`[object Float64Array]`,se=`[object Int8Array]`,ce=`[object Int16Array]`,le=`[object Int32Array]`,S=`[object Uint8Array]`,ue=`[object Uint8ClampedArray]`,de=`[object Uint16Array]`,fe=`[object Uint32Array]`,pe=/[\\^$.*+?()[\]{}|]/g,me=/^\[object .+?Constructor\]$/,he=/^(?:0|[1-9]\d*)$/,C={};C[ae]=C[oe]=C[se]=C[ce]=C[le]=C[S]=C[ue]=C[de]=C[fe]=!0,C[s]=C[c]=C[re]=C[u]=C[ie]=C[d]=C[f]=C[p]=C[h]=C[g]=C[v]=C[ee]=C[b]=C[te]=C[x]=!1;var w=typeof global==`object`&&global&&global.Object===Object&&global,T=typeof self==`object`&&self&&self.Object===Object&&self,E=w||T||Function(`return this`)(),D=typeof e==`object`&&e&&!e.nodeType&&e,O=D&&typeof t==`object`&&t&&!t.nodeType&&t,ge=O&&O.exports===D,_e=ge&&w.process,k=function(){try{return O&&O.require&&O.require(`util`).types||_e&&_e.binding&&_e.binding(`util`)}catch{}}(),A=k&&k.isTypedArray;function ve(e,t,n){switch(n.length){case 0:return e.call(t);case 1:return e.call(t,n[0]);case 2:return e.call(t,n[0],n[1]);case 3:return e.call(t,n[0],n[1],n[2])}return e.apply(t,n)}function ye(e,t){for(var n=-1,r=Array(e);++n<e;)r[n]=t(n);return r}function j(e){return function(t){return e(t)}}function M(e,t){return e?.[t]}function N(e,t){return function(n){return e(t(n))}}var be=Array.prototype,xe=Function.prototype,P=Object.prototype,F=E[`__core-js_shared__`],I=xe.toString,L=P.hasOwnProperty,R=function(){var e=/[^.]+$/.exec(F&&F.keys&&F.keys.IE_PROTO||``);return e?`Symbol(src)_1.`+e:``}(),z=P.toString,Se=I.call(Object),Ce=RegExp(`^`+I.call(L).replace(pe,`\\$&`).replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,`$1.*?`)+`$`),B=ge?E.Buffer:void 0,we=E.Symbol,V=E.Uint8Array,H=B?B.allocUnsafe:void 0,U=N(Object.getPrototypeOf,Object),Te=Object.create,Ee=P.propertyIsEnumerable,W=be.splice,G=we?we.toStringTag:void 0,K=function(){try{var e=xt(Object,`defineProperty`);return e({},``,{}),e}catch{}}(),De=B?B.isBuffer:void 0,Oe=Math.max,ke=Date.now,Ae=xt(E,`Map`),q=xt(Object,`create`),je=function(){function e(){}return function(t){if(!Q(t))return{};if(Te)return Te(t);e.prototype=t;var n=new e;return e.prototype=void 0,n}}();function J(e){var t=-1,n=e==null?0:e.length;for(this.clear();++t<n;){var r=e[t];this.set(r[0],r[1])}}function Me(){this.__data__=q?q(null):{},this.size=0}function Ne(e){var t=this.has(e)&&delete this.__data__[e];return this.size-=+!!t,t}function Pe(e){var t=this.__data__;if(q){var n=t[e];return n===r?void 0:n}return L.call(t,e)?t[e]:void 0}function Fe(e){var t=this.__data__;return q?t[e]!==void 0:L.call(t,e)}function Ie(e,t){var n=this.__data__;return this.size+=+!this.has(e),n[e]=q&&t===void 0?r:t,this}J.prototype.clear=Me,J.prototype.delete=Ne,J.prototype.get=Pe,J.prototype.has=Fe,J.prototype.set=Ie;function Y(e){var t=-1,n=e==null?0:e.length;for(this.clear();++t<n;){var r=e[t];this.set(r[0],r[1])}}function Le(){this.__data__=[],this.size=0}function Re(e){var t=this.__data__,n=tt(t,e);return n<0?!1:(n==t.length-1?t.pop():W.call(t,n,1),--this.size,!0)}function ze(e){var t=this.__data__,n=tt(t,e);return n<0?void 0:t[n][1]}function Be(e){return tt(this.__data__,e)>-1}function Ve(e,t){var n=this.__data__,r=tt(n,e);return r<0?(++this.size,n.push([e,t])):n[r][1]=t,this}Y.prototype.clear=Le,Y.prototype.delete=Re,Y.prototype.get=ze,Y.prototype.has=Be,Y.prototype.set=Ve;function X(e){var t=-1,n=e==null?0:e.length;for(this.clear();++t<n;){var r=e[t];this.set(r[0],r[1])}}function He(){this.size=0,this.__data__={hash:new J,map:new(Ae||Y),string:new J}}function Ue(e){var t=bt(this,e).delete(e);return this.size-=+!!t,t}function We(e){return bt(this,e).get(e)}function Ge(e){return bt(this,e).has(e)}function Ke(e,t){var n=bt(this,e),r=n.size;return n.set(e,t),this.size+=n.size==r?0:1,this}X.prototype.clear=He,X.prototype.delete=Ue,X.prototype.get=We,X.prototype.has=Ge,X.prototype.set=Ke;function Z(e){var t=this.__data__=new Y(e);this.size=t.size}function qe(){this.__data__=new Y,this.size=0}function Je(e){var t=this.__data__,n=t.delete(e);return this.size=t.size,n}function Ye(e){return this.__data__.get(e)}function Xe(e){return this.__data__.has(e)}function Ze(e,t){var r=this.__data__;if(r instanceof Y){var i=r.__data__;if(!Ae||i.length<n-1)return i.push([e,t]),this.size=++r.size,this;r=this.__data__=new X(i)}return r.set(e,t),this.size=r.size,this}Z.prototype.clear=qe,Z.prototype.delete=Je,Z.prototype.get=Ye,Z.prototype.has=Xe,Z.prototype.set=Ze;function Qe(e,t){var n=Rt(e),r=!n&&Lt(e),i=!n&&!r&&Vt(e),a=!n&&!r&&!i&&Gt(e),o=n||r||i||a,s=o?ye(e.length,String):[],c=s.length;for(var l in e)(t||L.call(e,l))&&!(o&&(l==`length`||i&&(l==`offset`||l==`parent`)||a&&(l==`buffer`||l==`byteLength`||l==`byteOffset`)||wt(l,c)))&&s.push(l);return s}function $e(e,t,n){(n!==void 0&&!It(e[t],n)||n===void 0&&!(t in e))&&nt(e,t,n)}function et(e,t,n){var r=e[t];(!(L.call(e,t)&&It(r,n))||n===void 0&&!(t in e))&&nt(e,t,n)}function tt(e,t){for(var n=e.length;n--;)if(It(e[n][0],t))return n;return-1}function nt(e,t,n){t==`__proto__`&&K?K(e,t,{configurable:!0,enumerable:!0,value:n,writable:!0}):e[t]=n}var rt=yt();function it(e){return e==null?e===void 0?ne:_:G&&G in Object(e)?St(e):At(e)}function at(e){return $(e)&&it(e)==s}function ot(e){return!Q(e)||Dt(e)?!1:(Ht(e)?Ce:me).test(Ft(e))}function st(e){return $(e)&&Ut(e.length)&&!!C[it(e)]}function ct(e){if(!Q(e))return kt(e);var t=Ot(e),n=[];for(var r in e)r==`constructor`&&(t||!L.call(e,r))||n.push(r);return n}function lt(e,t,n,r,i){e!==t&&rt(t,function(a,o){if(i||=new Z,Q(a))ut(e,t,o,n,lt,r,i);else{var s=r?r(Mt(e,o),a,o+``,e,t,i):void 0;s===void 0&&(s=a),$e(e,o,s)}},qt)}function ut(e,t,n,r,i,a,o){var s=Mt(e,n),c=Mt(t,n),l=o.get(c);if(l){$e(e,n,l);return}var u=a?a(s,c,n+``,e,t,o):void 0,d=u===void 0;if(d){var f=Rt(c),p=!f&&Vt(c),m=!f&&!p&&Gt(c);u=c,f||p||m?Rt(s)?u=s:Bt(s)?u=gt(s):p?(d=!1,u=pt(c,!0)):m?(d=!1,u=ht(c,!0)):u=[]:Wt(c)||Lt(c)?(u=s,Lt(s)?u=Kt(s):(!Q(s)||Ht(s))&&(u=Ct(c))):d=!1}d&&(o.set(c,u),i(u,c,r,a,o),o.delete(c)),$e(e,n,u)}function dt(e,t){return Nt(jt(e,t,Xt),e+``)}var ft=K?function(e,t){return K(e,`toString`,{configurable:!0,enumerable:!1,value:Yt(t),writable:!0})}:Xt;function pt(e,t){if(t)return e.slice();var n=e.length,r=H?H(n):new e.constructor(n);return e.copy(r),r}function mt(e){var t=new e.constructor(e.byteLength);return new V(t).set(new V(e)),t}function ht(e,t){var n=t?mt(e.buffer):e.buffer;return new e.constructor(n,e.byteOffset,e.length)}function gt(e,t){var n=-1,r=e.length;for(t||=Array(r);++n<r;)t[n]=e[n];return t}function _t(e,t,n,r){var i=!n;n||={};for(var a=-1,o=t.length;++a<o;){var s=t[a],c=r?r(n[s],e[s],s,n,e):void 0;c===void 0&&(c=e[s]),i?nt(n,s,c):et(n,s,c)}return n}function vt(e){return dt(function(t,n){var r=-1,i=n.length,a=i>1?n[i-1]:void 0,o=i>2?n[2]:void 0;for(a=e.length>3&&typeof a==`function`?(i--,a):void 0,o&&Tt(n[0],n[1],o)&&(a=i<3?void 0:a,i=1),t=Object(t);++r<i;){var s=n[r];s&&e(t,s,r,a)}return t})}function yt(e){return function(t,n,r){for(var i=-1,a=Object(t),o=r(t),s=o.length;s--;){var c=o[e?s:++i];if(n(a[c],c,a)===!1)break}return t}}function bt(e,t){var n=e.__data__;return Et(t)?n[typeof t==`string`?`string`:`hash`]:n.map}function xt(e,t){var n=M(e,t);return ot(n)?n:void 0}function St(e){var t=L.call(e,G),n=e[G];try{e[G]=void 0;var r=!0}catch{}var i=z.call(e);return r&&(t?e[G]=n:delete e[G]),i}function Ct(e){return typeof e.constructor==`function`&&!Ot(e)?je(U(e)):{}}function wt(e,t){var n=typeof e;return t??=o,!!t&&(n==`number`||n!=`symbol`&&he.test(e))&&e>-1&&e%1==0&&e<t}function Tt(e,t,n){if(!Q(n))return!1;var r=typeof t;return(r==`number`?zt(n)&&wt(t,n.length):r==`string`&&t in n)?It(n[t],e):!1}function Et(e){var t=typeof e;return t==`string`||t==`number`||t==`symbol`||t==`boolean`?e!==`__proto__`:e===null}function Dt(e){return!!R&&R in e}function Ot(e){var t=e&&e.constructor;return e===(typeof t==`function`&&t.prototype||P)}function kt(e){var t=[];if(e!=null)for(var n in Object(e))t.push(n);return t}function At(e){return z.call(e)}function jt(e,t,n){return t=Oe(t===void 0?e.length-1:t,0),function(){for(var r=arguments,i=-1,a=Oe(r.length-t,0),o=Array(a);++i<a;)o[i]=r[t+i];i=-1;for(var s=Array(t+1);++i<t;)s[i]=r[i];return s[t]=n(o),ve(e,this,s)}}function Mt(e,t){if(!(t===`constructor`&&typeof e[t]==`function`)&&t!=`__proto__`)return e[t]}var Nt=Pt(ft);function Pt(e){var t=0,n=0;return function(){var r=ke(),o=a-(r-n);if(n=r,o>0){if(++t>=i)return arguments[0]}else t=0;return e.apply(void 0,arguments)}}function Ft(e){if(e!=null){try{return I.call(e)}catch{}try{return e+``}catch{}}return``}function It(e,t){return e===t||e!==e&&t!==t}var Lt=at(function(){return arguments}())?at:function(e){return $(e)&&L.call(e,`callee`)&&!Ee.call(e,`callee`)},Rt=Array.isArray;function zt(e){return e!=null&&Ut(e.length)&&!Ht(e)}function Bt(e){return $(e)&&zt(e)}var Vt=De||Zt;function Ht(e){if(!Q(e))return!1;var t=it(e);return t==p||t==m||t==l||t==y}function Ut(e){return typeof e==`number`&&e>-1&&e%1==0&&e<=o}function Q(e){var t=typeof e;return e!=null&&(t==`object`||t==`function`)}function $(e){return typeof e==`object`&&!!e}function Wt(e){if(!$(e)||it(e)!=v)return!1;var t=U(e);if(t===null)return!0;var n=L.call(t,`constructor`)&&t.constructor;return typeof n==`function`&&n instanceof n&&I.call(n)==Se}var Gt=A?j(A):st;function Kt(e){return _t(e,qt(e))}function qt(e){return zt(e)?Qe(e,!0):ct(e)}var Jt=vt(function(e,t,n){lt(e,t,n)});function Yt(e){return function(){return e}}function Xt(e){return e}function Zt(){return!1}t.exports=Jt}))(),1);function u(){let e=[];return{hasListener(t){return e.includes(t)},hasListeners(){return e.length>0},addListener(t){e.push(t)},removeListener(t){let n=e.indexOf(t);n>=0&&e.splice(n,1)},removeAllListeners(){e.length=0},async trigger(...t){return await Promise.all(e.map(e=>e(...t)))}}}let d=u(),f=`#5F5D5B`,p=`#FFFFFF`,m={global:p,tabs:new Map,windows:new Map},h={global:``,tabs:new Map,windows:new Map},g={global:v(f),tabs:new Map,windows:new Map},_={global:``,tabs:new Map,windows:new Map};function v(e){e=e.replace(`#`,``);let t=e.length===8,n=parseInt(e,16);return[n>>(t?24:16)&255,n>>(t?16:8)&255,n>>(t?8:0)&255,t?n&255:255]}function y(e,t){if(!t)return e.global;let{tabId:n,windowId:r}=t;return n===void 0?r===void 0?e.global:e.windows.get(r):e.tabs.get(n)}let ee={resetState(){d.removeAllListeners(),h.global=``,h.tabs.clear(),h.windows.clear(),g.global=v(f),g.tabs.clear(),g.windows.clear(),m.global=p,m.tabs.clear(),m.windows.clear(),_.global=``,_.tabs.clear(),_.windows.clear()},setTitle(e){let{title:t,tabId:n,windowId:r}=e;return n===void 0?r===void 0?_.global=t??``:t==null?_.windows.delete(r):_.windows.set(r,t):t==null?_.tabs.delete(n):_.tabs.set(n,t),Promise.resolve()},getTitle(e){let t=y(_,e);return Promise.resolve(t??``)},setBadgeText(e){let{text:t,tabId:n,windowId:r}=e;return n===void 0?r===void 0?h.global=t??``:t==null?h.windows.delete(r):h.windows.set(r,t):t==null?h.tabs.delete(n):h.tabs.set(n,t),Promise.resolve()},getBadgeText(e){let t=y(h,e);return Promise.resolve(t??``)},setBadgeBackgroundColor(e){let{color:t,tabId:n,windowId:r}=e,i;return i=typeof t==`string`?v(t):Array.isArray(t)?[...t]:v(f),n===void 0?r===void 0?g.global=i:g.windows.set(r,i):g.tabs.set(n,i),Promise.resolve()},getBadgeBackgroundColor(e){let t=y(g,e);return Promise.resolve(t??v(f))},setBadgeTextColor(e){let{color:t,tabId:n,windowId:r}=e,i=typeof t==`string`?t:p;n===void 0?r===void 0?m.global=i:t==null?m.windows.delete(r):m.windows.set(r,i):t==null?m.tabs.delete(n):m.tabs.set(n,i)},getBadgeTextColor(e,t){let n=y(m,e);t?.(n??p)},onClicked:d},b=[],te=u(),ne={resetState(){b.length=0,te.removeAllListeners()},async clear(e){e??=``;let t=b.findIndex(t=>t.name===e);return t>=0?(b.splice(t,1),!0):!1},async clearAll(){let e=b.length>0;return b.length=0,e},create(e,t){let n,r;typeof e==`object`?(n=``,r=e):(n=e??``,r=t);let i=b.findIndex(e=>e.name===n);i>=0&&b.splice(i,1),b.push({name:n,scheduledTime:r.when??Date.now()+(r.delayInMinutes??0)*6e4,periodInMinutes:r.periodInMinutes})},async get(e){return e??=``,b.find(t=>t.name===e)},async getAll(){return b},onAlarm:te},x={},re=u(),ie=u(),ae=u(),oe=u();async function se(e,t){let n,r;return t==null?(n=String(Math.random()),r=e):(n=e,r=t),ce(n)&&await le.clear(n),x[n]=r,n}function ce(e){return!!x[e]}let le={resetState(){x={},re.removeAllListeners(),ie.removeAllListeners(),ae.removeAllListeners(),oe.removeAllListeners()},create:se,async clear(e){let t=ce(e);return delete x[e],t},async getAll(){return x},onClosed:re,onClicked:ie,onButtonClicked:ae,onShown:oe},S=u(),ue=u(),de=u(),fe=u(),pe=u(),me=u(),he=`test-extension-id`,C={resetState(){S.removeAllListeners(),ue.removeAllListeners(),de.removeAllListeners(),fe.removeAllListeners(),pe.removeAllListeners(),me.removeAllListeners(),C.id=he},id:he,getURL(e){return`chrome-extension://${C.id}/${e.replace(/^\//,``)}`},onInstalled:ue,onMessage:S,onStartup:de,onSuspend:fe,onSuspendCanceled:pe,onUpdateAvailable:me,async sendMessage(e,t,n){let r;if(r=arguments.length===1||arguments.length===2&&typeof t==`object`?e:t,!S.hasListeners())throw Error(`No listeners available`);return(await S.trigger(r,{})).find(e=>!!e)}},w=u();function T(e){let t={},n=u();function r(e){return Array.isArray(e)?e:[e]}return{resetState(){n.removeAllListeners();for(let e of Object.keys(t))delete t[e]},async clear(){let r={};for(let e of Object.keys(t))r[e]={oldValue:t[e]??null,newValue:null},delete t[e];await n.trigger(r),await w.trigger(r,e)},async get(e){if(e==null)return{...t};let n={};return typeof e==`object`&&!Array.isArray(e)?Object.keys(e).forEach(r=>n[r]=t[r]??e[r]):r(e).forEach(e=>n[e]=t[e]),n},async remove(i){let a={};for(let e of r(i))a[e]={oldValue:t[e]??null,newValue:null},delete t[e];await n.trigger(a),await w.trigger(a,e)},async set(r){let i={};for(let[e,n]of Object.entries(JSON.parse(JSON.stringify(r))))n!==void 0&&(i[e]={oldValue:t[e]??null,newValue:n},n==null?delete t[e]:t[e]=n);await n.trigger(i),await w.trigger(i,e)},onChanged:n}}let E={...T(`local`),QUOTA_BYTES:5242880},D={...T(`managed`),QUOTA_BYTES:5242880},O={...T(`session`),QUOTA_BYTES:10485760},ge={...T(`sync`),MAX_ITEMS:512,MAX_WRITE_OPERATIONS_PER_HOUR:1800,MAX_WRITE_OPERATIONS_PER_MINUTE:120,QUOTA_BYTES:102400,QUOTA_BYTES_PER_ITEM:8192,getBytesInUse:()=>{throw Error(`Browser.storage.sync.getBytesInUse not implemented.`)}},_e={resetState(){E.resetState(),D.resetState(),O.resetState(),ge.resetState(),w.removeAllListeners()},local:E,managed:D,session:O,sync:ge,onChanged:w},k=u(),A=u(),ve=u(),ye={id:0,alwaysOnTop:!1,incognito:!1},j=[ye],M,N,be=1;function xe(e){N=M,M=e}function P(){let e=be;return be++,e}function F(e,t){return{...e,tabs:t?.populate?V.filter(t=>t.windowId===e.id).map(W):void 0,focused:e.id===M}}function I(e){if(e!=null)return e==`detached_panel`?`panel`:e}let L={resetState(){j.length=1,j[0]=ye,M=void 0,N=void 0,be=1,k.removeAllListeners(),A.removeAllListeners(),ve.removeAllListeners()},async get(e,t){let n=j.find(t=>t.id===e);if(n)return F(n,t)},getCurrent(e){if(M!=null)return L.get(M,e)},getLastFocused(e){if(N!=null)return L.get(N,e)},async getAll(e){return j.map(t=>F(t,e))},async create(e){let t={id:P(),alwaysOnTop:!1,incognito:e?.incognito??!1,height:e?.height,left:e?.left,state:e?.state,top:e?.top,type:I(e?.type),width:e?.width};j.push(t),e?.focused&&xe(t.id);let n=F(t);return await k.trigger(n),e?.focused&&ve.trigger(n.id),n},async update(e,t){let n=j.find(t=>t.id===e);if(n)return F(n)},async remove(e){let t=j.findIndex(t=>t.id===e);t<0||(j.splice(t,1),await A.trigger(e))},onCreated:k,onRemoved:A,onFocusChanged:ve},R=u(),z=u(),Se=u(),Ce=u(),B=u(),we={id:0,index:0,highlighted:!1,incognito:!1,pinned:!1,windowId:ye.id},V=[we],H,U=1;function Te(e){H=e}function Ee(){let e=U;return U++,e}function W(e){return{...e,active:H===e.id}}let G={resetState(){V.length=1,V[0]=we,H=void 0,U=1,R.removeAllListeners(),z.removeAllListeners(),Se.removeAllListeners(),Ce.removeAllListeners(),B.removeAllListeners()},async get(e){let t=V.find(t=>t.id===e);if(t)return W(t)},getCurrent(){if(H!=null)return G.get(H)},async create(e){let t=e.windowId?await L.get(e.windowId,{populate:!0}):await L.getCurrent({populate:!0}),n={highlighted:!1,incognito:!1,index:t?.tabs?.length??0,pinned:e.pinned??!1,windowId:t?.id??0,id:Ee(),url:e.url};V.push(n);let r=W(n);return await z.trigger(r),r},async duplicate(e,t){let n={...await G.get(e),id:Ee()},r=H;t?.active&&Te(n.id);let i=W(n);return await z.trigger(i),t?.active&&await R.trigger({tabId:i.id,windowId:i.windowId,previousTabId:r}),i},async query(e){let t=await L.getCurrent(),n=await L.getLastFocused();return V.filter(r=>{let i=!0;return e.active!=null&&(i&&=H===r.id),e.attention!=null&&(i&&=r.attention===e.attention),e.audible!=null&&(i&&=r.audible===e.audible),e.autoDiscardable!=null&&(i&&=r.autoDiscardable===e.autoDiscardable),e.camera!=null&&(i=!1),e.cookieStoreId!=null&&(i&&=r.cookieStoreId===e.cookieStoreId),e.currentWindow!=null&&e.currentWindow&&(i&&=t.id===r.windowId),e.currentWindow!=null&&!e.currentWindow&&(i&&=t.id!==r.windowId),e.windowId!=null&&(i&&=r.windowId===e.windowId),e.discarded!=null&&(i&&=r.discarded===e.discarded),e.hidden!=null&&(i&&=r.hidden===e.hidden),e.highlighted!=null&&(i&&=r.highlighted===e.highlighted),e.index!=null&&(i&&=r.index===e.index),e.lastFocusedWindow!=null&&e.lastFocusedWindow&&(i&&=n.id===r.windowId),e.lastFocusedWindow!=null&&!e.lastFocusedWindow&&(i&&=n.id!==r.windowId),e.microphone!=null&&(i=!1),e.muted!=null&&(i&&=r.mutedInfo?.muted===e.muted),e.openerTabId!=null&&(i&&=!!r.openerTabId),e.pinned!=null&&(i&&=r.pinned===e.pinned),e.screen!=null&&(i=!1),e.status!=null&&(i&&=r.status===e.status),e.title!=null&&(i&&=r.title==e.title),e.url!=null&&(i&&=r.url===e.url),e.windowType!=null&&(i=!1),i}).map(W)},async highlight(e){let t=Array.isArray(e.tabs)?e.tabs:[e.tabs],n;for(let e of t){let t=await G.get(e);t&&(n=await L.get(t.windowId),t.highlighted=!0)}return await Ce.trigger({tabIds:t,windowId:n.id}),n},async update(e,t){let n;n=e!==void 0&&typeof e==`object`?e:t;let r;r=typeof e==`number`?e:(await L.getCurrent()).tabs.find(e=>e.active).id;let i=await G.get(r);if(!i)throw Error(`Tab not found`);let a={...i,...n},o=V.findIndex(e=>e.id===r);V[o]=a;let s=W(a);return await Se.trigger(s.id,n,s),s},async remove(e){let t=Array.isArray(e)?e:[e];for(let e of t){let t=V.findIndex(t=>t.id===e);if(t>=0){let[n]=V.splice(t,1),r=await L.get(n.id,{populate:!0});await B.trigger(e,{isWindowClosing:!1,windowId:r.id}),r.tabs?.length||await L.remove(r.id)}}},onCreated:z,onUpdated:Se,onActivated:R,onHighlighted:Ce,onRemoved:B},K={onBeforeNavigate:u(),onCommitted:u(),onCompleted:u(),onCreatedNavigationTarget:u(),onDOMContentLoaded:u(),onErrorOccurred:u(),onHistoryStateUpdated:u(),onReferenceFragmentUpdated:u(),onTabReplaced:u()},De={activityLog:{onExtensionActivity:{addListener:()=>{throw Error(`Browser.activityLog.onExtensionActivity.addListener not implemented.
...
Mock the function yourself using your testing framework, or submit a PR with an in-memory implementation.`)}},WINDOW_ID_NONE:-1,WINDOW_ID_CURRENT:-2}},Oe={reset(){for(let[e,t]of Object.entries(ke))e!==`reset`&&t.resetState?.()},alarms:ne,notifications:le,runtime:C,storage:_e,tabs:G,webNavigation:K,windows:L,action:ee},ke=(0,l.default)(De,Oe);return e.fakeBrowser=ke,e})({});