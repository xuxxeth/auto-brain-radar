import { Action, Alarms, Browser, Notifications, Runtime, Storage, Tabs, WebNavigation, Windows } from "webextension-polyfill";
...
interface BrowserOverrides {
  ...
  storage: {
    /** Remove all listeners and clear in-memory storages. */resetState(): void;
    local: {
  ...
  tabs: Pick<Tabs.Static, 'get' | 'getCurrent' | 'create' | 'duplicate' | 'query' | 'highlight' | 'remove' | 'update'> & {
    resetState(): void;
    onCreated: EventForTesting<[tab: Tabs.Tab]>;
    onUpdated: EventForTesting<[tabId: number, changeInfo: Tabs.OnUpdatedChangeInfoType, tab: Tabs.Tab]>;
  ...
  webNavigation: {
    ...
    onCreatedNavigationTarget: EventForTesting<[details: WebNavigation.OnCreatedNavigationTargetDetailsType]>;
    onReferenceFragmentUpdated: EventForTesting<[details: WebNavigation.OnReferenceFragmentUpdatedDetailsType]>;
    onTabReplaced: EventForTesting<[details: WebNavigation.OnTabReplacedDetailsType]>;
    onHistoryStateUpdated: EventForTesting<[details: WebNavigation.OnHistoryStateUpdatedDetailsType]>;
  };
  ...
  action: Pick<Action.Static, 'setTitle' | 'getTitle' | 'getBadgeText' | 'setBadgeText' | 'setBadgeTextColor' | 'getBadgeTextColor' | 'getBadgeBackgroundColor' | 'setBadgeBackgroundColor'> & {
    resetState(): void;
...
//#endregion
export { type FakeBrowser, fakeBrowser };